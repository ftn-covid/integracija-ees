...
namespace FTN.ESI.SIMES.CIM.Model
{
    ...
    public class Profile
    {
        ...
        public override string ToString()
        {
            ...
            if (profileMap != null)
            {
                //TODO why do we get different class and prop numbers here
                //NOTE Class and property count are built in function
                toStringBuilder.Append($"Class count: {this.ClassCount}\n");
                toStringBuilder.Append($"Property count: {this.PropertyCount}\n");
