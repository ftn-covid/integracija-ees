...
namespace FTN.ESI.SIMES.CIM.Parser.Handler
{
    internal class RDFSXMLReaderHandler : IHandler
    {
        ...
        private int cntClasses = 0;
        private int cntComments = 0;
        private int cntProps = 0;
        ...
        public void GetCounter(out int cntClasses, out int cntProps, out int cntComments)
        {
            cntProps = this.cntProps;
            cntClasses = this.cntClasses;
            cntComments = this.cntComments;
        }
