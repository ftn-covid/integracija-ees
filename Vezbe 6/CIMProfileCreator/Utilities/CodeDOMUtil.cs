...
namespace TelventDMS.Integration.CIM.Utilities
{
	/// <summary>
    ...
    public class CodeDOMUtil
    {
        ...
        public void CompileCode(string fileName)
        {
            ...
            foreach(CodeCompileUnit unit in Files)
            {
                if(unit != null)
                {
					//if (unit.Namespaces[0].Types[0].Name.Equals("CoordinateSystem") || unit.Namespaces[0].Types[0].Name.Equals("Location") || unit.Namespaces[0].Types[0].Name.Equals("IDClass") ||  unit.Namespaces[0].Types[0].Name.Equals("IdentifiedObject"))
					//{
