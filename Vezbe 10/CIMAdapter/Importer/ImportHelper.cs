...
namespace FTN.ESI.SIMES.CIM.CIMAdapter.Importer
{
	...
	public class ImportHelper
	{
		...
		/// <summary>
		/// Method returns the value of gid that is mapped to given rdfID. If there is no mapping defined, method returns 0.
		/// </summary>
		/// <param name="rdfID">CIM rdfID value</param>
		/// <returns>gid or 0 (if mapping not defined)</returns>
